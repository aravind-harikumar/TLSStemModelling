function [vCellData, PCData] = formVoxelSpace(PCData, VDim, printVoxel, voxelTransparency)
...
%get neigbourhood indices for every voxel;
%[vCellData, PCData] = getVoxelDensityAndNebrCellIndices(PCData, rX, rY, rZ, VDim.xDiv, VDim.yDiv, VDim.zDiv);

%get neigbourhood density for every voxel;
%vCellData.voxNeighArrDensity = getVoxelNeighDensity(vCellData, rX, rY, rZ);
