function dataAtt = dataPreProcessing(singleTreeLiDARdata,inParams)
...
%lidarDataArr = lidarDataArr(dist2center>0.1,:);
        ...
        % end
dataAtt.tmplidarDataArray = lidarDataArr;
if(size(lidarDataArr,1)>100000)
    lidarDataArr = lidarDataArr(randperm(size(lidarDataArr,1),100001),:);
end
